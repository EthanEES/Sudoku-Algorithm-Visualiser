	...
	return (
		<div className="flex font-spacegrotesk justify-center">
			...
			<div className="grid grid-cols-3 w-screen max-w-[1920px] justify-center items-center h-screen py-28">
				<div className="pl-16">
					<div className="pb-10  place-items-center">
						...
						<ul className="list-disc p-2.5 pl-8 w-full h-60 text-sm text-gray-50 bg-[#1b212c] border rounded-2xl border-white">
							<li className="pb-1">
								Constraint Propagation refers to the reduction of domain variables
								and possibilities of a variable.
							</li>
							<li className="pb-1">
								In our case, in relation to sudoku, we can state that all cells
								within the grid have a "domain", the possible values that can go in
								each square.
							</li>
							<li className="pb-1">
								Constraint Propagation will look at each domain and apply the rules
								of sudoku to trim the domain and get rid of values that are not
								applicable.
							</li>
							<li className="pb-1">
								This way, when we backtrack we have alot less possibilities to try,
								meaning a much faster time Complexity.
							</li>
						</ul>
					</div>
				...
				<div
					id="GridDiv"
					className="flex flex-col justify-center items-center scale-[110%]">
					...
					{gridSize} x {gridSize}
					<button
						onClick={() => longFunction(checkGrid, gridSolution)}
				...
				<div className="place-items-center">
					...
					<div className="grid grid-cols-2 p-2.5 w-4/5 h-108 pb-60 text-sm text-gray-50 bg-[#1b212c] border rounded-2xl border-white">
						<p id="Domains1" className="p-2.5 h-96 text-sm text-gray-50"></p>
						<p id="Domains2" className="p-2.5 h-96 text-sm text-gray-50 "></p>
					</div>
				</div>
			</div>
		</div>
